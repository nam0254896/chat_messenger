import 'package:chat_messenger/services/auth.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  signUp(){
    ...
    authMethods.signUpWithEmailAndPassword(emailTextEdittingController.text, passWordTextEdittingController.text)!.then((val) {
      print("$val");
    });
    }
  }
